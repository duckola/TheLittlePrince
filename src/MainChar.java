...
public class MainChar extends Base{
    ...
    public MainChar(String name){
        super(name,100,100,10,100,0,100,1,100,1.0,"Blade Strike","Swords Dance","Judgement");
    ...
    public void upgradeStats(int maxMana){
        this.maxMana = maxMana + (maxMana*(2/3));
    }
}