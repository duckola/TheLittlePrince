public class Narration {
    ...
    private String[] dialogues = {
        ...
        "You reach for your phone and see a notification on the screen.",
        "You decide to continue sleeping, enjoying a few more minutes of peace. After an hour, your phone’s alarm started to ring. You turn the alarm off and check your phone. You saw an email from a sender named Anonymous with the subject line “CC. Little Prince”. Out of curiosity, you read the email and saw that you are the chosen participant in what they called the “Cosmic Challenge",
        "You wanted to know more about the game so you scan the QR code attached to it. It redirects to a website with a timer countdown (00: 01: 10)  and the text “GAME STARTS AT”. In a panic, you close the website and delete the email sent to you. And suddenly…",
        "Where am I?",
        "Hello there little one, I'm Sira, your virtual companion throughout your journey. Welcome to the Cosmic Challenge. The Cosmic Challenge is a high-stakes, intergalactic competition that draws beings from diverse planets into a relentless battle for survival. This daunting arena serves not only as a test of physical strength and slyness but also as a profound journey of self-discovery and exploration of the nature of existence.",
        "You have 100 hp at the start of the challenge. Throughout the challenge, you can collect petals by defeating minions—each rose collected will gain you experience (+EXP).",
        "To unlock new planets, you’ll need to gather keys. You can view your inventory anytime to check your items and change your skills when you acquire new ones. Make wise choices, as they may be crucial for your survival. Good luck, and remember: The little prince is watching.",
        "You have 100 hp at the start of the challenge. Throughout the challenge, you can collect petals by defeating minions—each rose collected will gain you experience (+EXP)",
        "To unlock new planets, you’ll need to gather keys. You can view your inventory anytime to check your items and change your skills when you acquire new ones. Make wise choices, as they may be crucial for your survival. Good luck, and remember: The little prince is watching.",
